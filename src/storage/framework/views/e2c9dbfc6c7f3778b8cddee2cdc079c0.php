<footer class="border-t bg-gray-900 text-gray-300">
  <div class="mx-auto grid gap-8 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
    ...
    <div>
      ...
      <ul class="mt-3 space-y-2 text-sm">
        <li><a href="<?php echo e(route('catalog')); ?>" class="hover:text-white">Catálogo</a></li>
        <li><a href="<?php echo e(route('nosotros')); ?>" class="hover:text-white">Nosotros</a></li>
        <li><a href="<?php echo e(route('account')); ?>" class="hover:text-white">Cuenta</a></li>
        <li><a href="<?php echo e(route('cart')); ?>" class="hover:text-white">Carrito</a></li>
      </ul>
    </div>
    <div>
      <h4 class="text-sm font-semibold uppercase tracking-wide text-gray-200">Soporte</h4>
      <ul class="mt-3 space-y-2 text-sm">
        <li><a href="<?php echo e(route('nosotros')); ?>#faq" class="hover:text-white">Preguntas frecuentes</a></li>
        <li><a href="<?php echo e(route('nosotros')); ?>#politicas" class="hover:text-white">Políticas</a></li>
  ...
  <div class="border-t border-gray-800">
    <div class="mx-auto flex flex-col items-center justify-between gap-2 px-4 py-4 text-xs text-gray-500 sm:flex-row sm:px-6 lg:px-8">
      <span>&copy; <?php echo e(date('Y')); ?> PolyCrochet. Todos los derechos reservados.</span>
      <a href="<?php echo e(route('admin.dashboard')); ?>" class="hover:text-white">Acceso administrador</a>
    </div>
  </div>
</footer>
<?php /**PATH C:\Users\Alexis\Desktop\polycrochet\resources\views/components/footer.blade.php ENDPATH**/ ?>