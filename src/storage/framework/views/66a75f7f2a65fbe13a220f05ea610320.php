<?php $__env->startSection('title', 'Carrito | PolyCrochet'); ?>
...
<?php $__env->startSection('content'); ?>
  <section class="grid gap-8 lg:grid-cols-[2fr,1fr]">
    <div class="space-y-4">
        ...
        <article class="flex flex-col gap-4 rounded-2xl border border-gray-200 bg-white p-4 shadow-sm sm:flex-row sm:items-center">
          ...
          <div class="flex flex-1 flex-col gap-2">
            <div class="flex flex-wrap items-baseline justify-between gap-2">
              <h2 class="text-lg font-semibold">Producto artesanal <?php echo e($i); ?></h2>
      ...
      <?php endfor; ?>
      <a href="<?php echo e(route('catalog')); ?>" class="inline-flex items-center gap-2 text-sm font-semibold text-blue-600 hover:text-blue-500">Seguir explorando</a>
    </div>
    ...
    <aside class="space-y-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
      ...
      <a href="<?php echo e(route('checkout')); ?>" class="inline-flex w-full justify-center rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow hover:bg-blue-500">Proceder al checkout</a>
      <p class="text-xs text-gray-400">El total final se confirmará durante el pago en PayPal.</p>
    </aside>
  </section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Alexis\Desktop\polycrochet\resources\views/pages/cart.blade.php ENDPATH**/ ?>