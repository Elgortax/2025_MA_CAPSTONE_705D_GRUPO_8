<?php $__env->startSection('title', 'Inicio | PolyCrochet'); ?>
  ...
  <section class="space-y-12">
    <div class="grid gap-10 lg:grid-cols-[1.1fr,0.9fr] lg:items-center">
      <div class="space-y-6">
        ...
        <div class="flex flex-wrap gap-3">
          <a href="<?php echo e(route('catalog')); ?>" class="inline-flex items-center rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white hover:bg-blue-500">Ver catálogo</a>
          <a href="<?php echo e(route('nosotros')); ?>" class="inline-flex items-center rounded-full border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-700 hover:border-blue-400 hover:text-blue-600">Conoce nuestra historia</a>
        </div>
    ...
    <section class="space-y-6">
      <header class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        ...
        <a href="<?php echo e(route('catalog')); ?>" class="text-sm font-semibold text-blue-600 hover:text-blue-500">Ver todo</a>
      </header>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Alexis\Desktop\polycrochet\resources\views/pages/home.blade.php ENDPATH**/ ?>