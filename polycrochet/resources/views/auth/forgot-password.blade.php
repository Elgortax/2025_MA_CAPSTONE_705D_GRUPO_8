@extends('layouts.app')
@section('title', 'Recuperar contraseña | PolyCrochet')

@section('content')
  <section class="mx-auto max-w-md rounded-[2.5rem] border border-rose-100 bg-white/95 p-8 shadow-2xl shadow-rose-100/50">
    <h1 class="text-2xl font-semibold text-rose-700">Recuperar contraseña</h1>
    <p class="mt-2 text-sm text-slate-500">Ingresa el correo con el que te registraste y te enviaremos instrucciones.</p>
    ...
    <p class="mt-6 text-center text-sm text-slate-500">
      ...
      <a href="{{ route('login') }}" class="font-semibold text-rose-500 hover:text-rose-600">Volver al inicio de sesión</a>
    </p>
  </section>
@endsection
