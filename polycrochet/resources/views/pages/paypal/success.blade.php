...
@section('content')
  <section class="mx-auto max-w-2xl space-y-6 text-center">
    ...
    <div class="flex justify-center gap-4">
      ...
      <a href="{{ route('catalog') }}" class="rounded-full border border-gray-300 px-6 py-3 text-sm font-semibold text-gray-700 hover:border-blue-400 hover:text-blue-600">Volver al catálogo</a>
    </div>
  </section>
@endsection
