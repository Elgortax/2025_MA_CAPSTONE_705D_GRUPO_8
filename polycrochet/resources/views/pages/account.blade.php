...
@section('content')
  <section class="grid gap-12 lg:grid-cols-2">
    <div class="space-y-6">
      ...
      <article class="space-y-4 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
        <div class="flex items-center gap-3">
          <div class="h-12 w-12 overflow-hidden rounded-xl border border-gray-100">
          ...
          <div>
            ...
            <p class="text-xs text-gray-500">Revisa tus pedidos y descarga comprobantes.</p>
          </div>
        </div>
    ...
    <article class="space-y-5 rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
