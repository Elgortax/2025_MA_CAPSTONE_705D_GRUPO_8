<footer class="border-t bg-gray-900 text-gray-300">
  <div class="mx-auto grid gap-8 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
    <div>
      ...
      <p class="mt-3 text-sm text-gray-400">Piezas tejidas a mano con cariño desde Chile. Inspirate, personaliza y recibe tus favoritos en casa.</p>
    </div>
    <div>
    ...
    <div>
      ...
      <ul class="mt-3 space-y-2 text-sm">
        ...
        <li><a href="{{ route('nosotros') }}#politicas" class="hover:text-white">Politicas</a></li>
    ...
    <div>
      <h4 class="text-sm font-semibold uppercase tracking-wide text-gray-200">Siguenos</h4>
      <ul class="mt-3 space-y-2 text-sm">
